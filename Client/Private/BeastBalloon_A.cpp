...
HRESULT CBeastBalloon_A::Render_Depth(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
...
HRESULT CBeastBalloon_A::Add_Components()
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_A Failed Clone Component : Com_RigidBody");
		return E_FAIL;
	}
	...
	{
		MSG_BOX("CLoadBeastBalloon_A Failed Clone Component : Com_Renderer");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_A::Add_Components_Level(_uint iCurrentLevelIndex)
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_A Failed Clone Component : Com_Model");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_A::SetUp_ShaderResources()
{
	BEGININSTANCE;
...
HRESULT CBeastBalloon_A::SetUp_ShadowShaderResources(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
	BEGININSTANCE;
