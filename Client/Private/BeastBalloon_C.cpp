...
HRESULT CBeastBalloon_C::Render_Depth(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
...
HRESULT CBeastBalloon_C::Add_Components()
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_C Failed Clone Component : Com_RigidBody");
		return E_FAIL;
	}
	...
	{
		MSG_BOX("CLoadBeastBalloon_C Failed Clone Component : Com_Renderer");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_C::Add_Components_Level(_uint iCurrentLevelIndex)
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_C Failed Clone Component : Com_Model");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_C::SetUp_ShaderResources()
{
	BEGININSTANCE;
...
HRESULT CBeastBalloon_C::SetUp_ShadowShaderResources(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
	BEGININSTANCE;
