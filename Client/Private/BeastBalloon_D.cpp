...
HRESULT CBeastBalloon_D::Render_Depth(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
...
HRESULT CBeastBalloon_D::Add_Components()
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_D Failed Clone Component : Com_RigidBody");
		return E_FAIL;
	}
	...
	{
		MSG_BOX("CLoadBeastBalloon_D Failed Clone Component : Com_Renderer");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_D::Add_Components_Level(_uint iCurrentLevelIndex)
{
	...
	{
		MSG_BOX("CLoadBeastBalloon_D Failed Clone Component : Com_Model");
		return E_FAIL;
	}
...
HRESULT CBeastBalloon_D::SetUp_ShaderResources()
{
	BEGININSTANCE;
...
HRESULT CBeastBalloon_D::SetUp_ShadowShaderResources(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
	BEGININSTANCE;
