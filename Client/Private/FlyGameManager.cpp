...
HRESULT CFlyGameManager::Add_Components()
{
	...
	ZEROMEM(&ScoreDesc);
	lstrcpy(ScoreDesc.wszNinthName, TEXT("악당8"));
	lstrcpy(ScoreDesc.wszSecondName, TEXT("악당1"));
	lstrcpy(ScoreDesc.wszThirdName, TEXT("악당2"));
	lstrcpy(ScoreDesc.wszFourthName, TEXT("악당3"));
	lstrcpy(ScoreDesc.wszFifthName, TEXT("악당4"));
	lstrcpy(ScoreDesc.wszSixthName, TEXT("악당5"));
	lstrcpy(ScoreDesc.wszSeventhName, TEXT("악당6"));
	lstrcpy(ScoreDesc.wszEighthName, TEXT("악당7"));
	lstrcpy(ScoreDesc.wszFirstName, TEXT("플레이어"));
