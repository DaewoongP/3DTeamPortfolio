...
HRESULT CGolem_Merlin::Make_Turns(_Inout_ CSequence* pSequence)
{
	BEGININSTANCE;
	...
	{
		wstring wstrErrorMSG = TEXT("[CGolem_Merlin] Failed Make_Turns : \n");
		wstrErrorMSG += pErrorTag;
		MSG_BOX(wstrErrorMSG.c_str());
...
HRESULT CGolem_Merlin::Make_Attack(_Inout_ CSelector* pSelector)
{
	BEGININSTANCE;
	...
	{
		wstring wstrErrorMSG = TEXT("[CGolem_Merlin] Failed Make_Attack : \n");
		wstrErrorMSG += pErrorTag;
		MSG_BOX(wstrErrorMSG.c_str());
...
HRESULT CGolem_Merlin::Make_NormalAttack(_Inout_ CSelector* pSelector)
{
	BEGININSTANCE;
	...
	{
		wstring wstrErrorMSG = TEXT("[CGolem_Merlin] Failed Make_NormalAttack : \n");
		wstrErrorMSG += pErrorTag;
		MSG_BOX(wstrErrorMSG.c_str());
...
HRESULT CGolem_Merlin::Make_Check_Spell(_Inout_ CSelector* pSelector)
{
	BEGININSTANCE;
	...
	{
		wstring wstrErrorMSG = TEXT("[CGolem_Merlin] Failed Make_Check_Spell : \n");
		wstrErrorMSG += pErrorTag;
		MSG_BOX(wstrErrorMSG.c_str());
...
HRESULT CGolem_Merlin::Make_Descendo(_Inout_ CSequence* pSequence)
{
	BEGININSTANCE;
	...
	{
		wstring wstrErrorMSG = TEXT("[CGolem_Merlin] Failed Make_Descendo : \n");
		wstrErrorMSG += pErrorTag;
		MSG_BOX(wstrErrorMSG.c_str());
