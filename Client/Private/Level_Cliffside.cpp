...
HRESULT CLevel_Cliffside::Ready_Layer_Monster(const _tchar* pLayerTag)
{
	...
	Matrix = XMMatrixTranslation(30.f, 10.f, 60.f);
	if (FAILED(pGameInstance->Add_Component(LEVEL_CLIFFSIDE, LEVEL_CLIFFSIDE, TEXT("Prototype_GameObject_Golem_CombatGrunt"), pLayerTag, TEXT("GameObject_Golem_Combat3"), &Matrix)))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_Golem_Combat)");
		ENDINSTANCE;
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Component(LEVEL_CLIFFSIDE, LEVEL_CLIFFSIDE, TEXT("Prototype_GameObject_Golem_CombatGrunt"), pLayerTag, TEXT("GameObject_Golem_Combat4"), &Matrix)))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_Golem_Combat)");
		ENDINSTANCE;
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Component(LEVEL_CLIFFSIDE, LEVEL_CLIFFSIDE, TEXT("Prototype_GameObject_Golem_CombatGrunt"), pLayerTag, TEXT("GameObject_Golem_Combat5"), &Matrix)))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_Golem_Combat)");
		ENDINSTANCE;
		return E_FAIL;
