...
HRESULT CLoader::Loading_For_MainGame()
{
	...
	try /* Failed Check Add_Prototype*/
	{
		...
		if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_GameObject_Armored_Troll"),
		...
		if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_GameObject_Forest_Troll"),
