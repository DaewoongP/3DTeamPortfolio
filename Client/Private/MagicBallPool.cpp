...
HRESULT CMagicBallPool::Initialize()
{
    ...
    Create_InitMagic(Client::PENSIVE_SWORD_THROW, TEXT("Prototype_GameObject_Pensive_Sword_Throw"), 6);
...
CMagicBall* CMagicBallPool::Create_Magic(SPELL eSpell)
{
    ...
    case Client::PENSIVE_FAIL_BALL:
        ...
        break;
    case Client::PENSIVE_SHOUTING:
        pMagicBall = static_cast<CMagicBall*>(pGameInstance->Clone_Component(LEVEL_STATIC, TEXT("Prototype_GameObject_Pensive_Shouting")));
        break;
