...
HRESULT CMenu_Inventory::Ready_Gear_Frame()
{
...
HRESULT CMenu_Inventory::Add_Components_Frame()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT CMenu_Inventory::Read_File_Frame(const _tchar* pFilePath)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT CMenu_Inventory::Ready_Gear_Slot(const _tchar* pFilePath, wstring wszTag, GEARSLOT eType)
{
...
HRESULT CMenu_Inventory::Add_Components_Slot(wstring wszTag)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT CMenu_Inventory::Read_File_Slot(const _tchar* pFilePath, wstring wszTag, GEARSLOT eType)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT CMenu_Inventory::Ready_Gear_Status()
{
...
HRESULT CMenu_Inventory::Add_Components_Status()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
	...
	CUI_Effect_Back* pHP = nullptr;
	CUI_Effect_Back* pDEF = nullptr;
	CUI_Effect_Back* pSTAT = nullptr;
...
HRESULT CMenu_Inventory::Read_File_Statust(const _tchar* pFilePath)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
