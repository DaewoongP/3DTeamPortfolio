...
HRESULT CPotion::Render_Depth(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
...
HRESULT CPotion::SetUp_ShadowShaderResources(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
	BEGININSTANCE;
