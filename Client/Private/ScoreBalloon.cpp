...
HRESULT CScoreBalloon::Render_Depth(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
...
HRESULT CScoreBalloon::Add_Components()
{
	...
	{
		MSG_BOX("CLoadScoreBalloon Failed Clone Component : Com_RigidBody");
		return E_FAIL;
	}
	...
	{
		MSG_BOX("CLoadScoreBalloon Failed Clone Component : Com_Renderer");
		return E_FAIL;
	}
...
HRESULT CScoreBalloon::Add_Components_Level(_uint iCurrentLevelIndex)
{
	...
	{
		MSG_BOX("CLoadScoreBalloon Failed Clone Component : Com_Model");
		return E_FAIL;
	}
...
HRESULT CScoreBalloon::SetUp_ShaderResources()
{
	BEGININSTANCE;
...
HRESULT CScoreBalloon::SetUp_ShadowShaderResources(_float4x4 LightViewMatrix, _float4x4 LightProjMatrix)
{
	BEGININSTANCE;
