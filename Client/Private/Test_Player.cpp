...
HRESULT CTest_Player::Add_Components()
{
	...
	m_pModelCom->Add_MeshParts(LEVEL_CLIFFSIDE, TEXT("Prototype_Component_MeshPart_Robe_Beast"), CCustomModel::ROBE, _float4(), TEXT("../../Resources/GameData/ClothData/Robe_Beast.cloth"));
