...
HRESULT CUI_Group_Finisher::Add_Prototype()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_CLIFFSIDE, TEXT("Prototype_GameObject_UI_Finisher"),
...
HRESULT CUI_Group_Finisher::Add_Components(wstring wszTag)
{
	...
	if (FAILED(CComposite::Add_Component(LEVEL_CLIFFSIDE, TEXT("Prototype_GameObject_UI_Finisher"),
