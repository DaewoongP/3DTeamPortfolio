...
CWeapon_Golem_Merlin::CWeapon_Golem_Merlin(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CParts(pDevice, pContext)
{
}

CWeapon_Golem_Merlin::CWeapon_Golem_Merlin(const CWeapon_Golem_Merlin& rhs)
	: CParts(rhs)
{
}

HRESULT CWeapon_Golem_Merlin::Initialize_Prototype()
{
	return __super::Initialize_Prototype();
}

HRESULT CWeapon_Golem_Merlin::Initialize(void* pArg)
{
...
void CWeapon_Golem_Merlin::Tick(_float fTimeDelta)
{
	__super::Tick(fTimeDelta);
}

void CWeapon_Golem_Merlin::Late_Tick(_float fTimeDelta)
{
...
HRESULT CWeapon_Golem_Merlin::Render()
{
...
HRESULT CWeapon_Golem_Merlin::Add_Components(void* pArg)
{
...
HRESULT CWeapon_Golem_Merlin::Set_Shader_Resources()
{
	BEGININSTANCE;
...
CWeapon_Golem_Merlin* CWeapon_Golem_Merlin::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CWeapon_Golem_Merlin* pInstance = new CWeapon_Golem_Merlin(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created CWeapon_Golem_Merlin");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CWeapon_Golem_Merlin* CWeapon_Golem_Merlin::Clone(void* pArg)
{
	CWeapon_Golem_Merlin* pInstance = new CWeapon_Golem_Merlin(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned CWeapon_Golem_Merlin");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CWeapon_Golem_Merlin::Free()
{
	__super::Free();
