...
class CAncientDoor_L final : public CMapObject
{
...
protected:
	explicit CAncientDoor_L(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CAncientDoor_L(const CAncientDoor_L& rhs);
	virtual ~CAncientDoor_L() = default;
...
public:
	static CAncientDoor_L* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
