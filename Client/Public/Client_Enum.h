...
#pragma endregion
	...
	enum ITEM_ID
	{
		...
		ITEM_ID_HAT_ARCANE,
		ITEM_ID_HAT_WIZARD,
		ITEM_ID_HAT_DARTARTS_DELUX,
		ITEM_ID_HAT_LODGOK,
		ITEM_ID_HAT_FEDORA,
		ITEM_ID_JACKET_ARCANE,
		ITEM_ID_JACKET_ARCANE_A,
		ITEM_ID_JACKET_CELTIC,
		ITEM_ID_JACKET_CELTIC_A,
		ITEM_ID_JACKET_DARKARTS_DELUX,
		ITEM_ID_JACKET_DARKARTS_DELUX_A,
		ITEM_ID_JACKET_DRAGONGRAB,
		ITEM_ID_JACKET_DRAGONGRAB_A,
		ITEM_ID_MASK_GUARDIAN,
		ITEM_ID_MASK_NIFFLER,
		ITEM_ID_MASK_DEMIGUISE,
		ITEM_ID_PANTS_ARCANE,
		ITEM_ID_PANTS_MERLIN,
		ITEM_ID_PANTS_DARKARTS_DELUX,
		ITEM_ID_PANTS_STEALTH,
		ITEM_ID_BOOTS_ARCANE,
		ITEM_ID_BOOTS_MERLIN,
		ITEM_ID_BOOTS_DEFAULT,
		ITEM_ID_END
	};
