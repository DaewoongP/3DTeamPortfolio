...
BEGIN(Client)
class CPensive_Ground_Ball final : public CMagicBall
{
private:
	explicit CPensive_Ground_Ball(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CPensive_Ground_Ball(const CPensive_Ground_Ball& rhs);
	virtual ~CPensive_Ground_Ball() = default;
...
public:
	static CPensive_Ground_Ball* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, _uint iLevel);
