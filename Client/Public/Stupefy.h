...
BEGIN(Client)
class CStupefy final : public CMagicBall
{
private:
	explicit CStupefy(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CStupefy(const CStupefy& rhs);
...
public:
	static CStupefy* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, _uint iLevel = 0);
