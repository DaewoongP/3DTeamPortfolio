...
HRESULT CDebug_Render_Capsule::Initialize(void* pArg)
{
	...
	SphereDesc.vOrigin = CapsuleDesc.vOrigin + _float3(0.f, CapsuleDesc.fHalfHeight, 0.f);
	_float3 vHighCenter = SphereDesc.vOrigin;
	/* For.Com_HighSphere */
	...
	SphereDesc.vOrigin = CapsuleDesc.vOrigin - _float3(0.f, CapsuleDesc.fHalfHeight, 0.f);
	_float3 vLowCenter = SphereDesc.vOrigin;
	/* For.Com_LowSphere */
	if (FAILED(CComposite::Add_Component(0, TEXT("Prototype_Component_Debug_Render_Sphere_For_Capsule"),
